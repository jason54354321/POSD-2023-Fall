...
TEST_HEADERS = test/json_test.h test/composite_test.h test/visitor_test.h test/parser_test.h
...
bin/ut_all: $(UT_ALL) $(TEST_HEADERS) $(SRC_HEADERS)
	g++ -g -std=c++11 -Wfatal-errors -Wall -o bin/ut_all $(UT_ALL) -lgtest -lpthread
